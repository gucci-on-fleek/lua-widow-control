...
\def\fillertext{
    ...
    \printlocation{0}This next paragraph is no longer from \emph{The \TeX{}book}; it is just here as\printlocation{1} a filler paragraph\printlocation{2} that is exactly 3~lines long. To do so, we just need two\printlocation{3} more sentences. That\printlocation{4} was the first second, and this is now the second.\printlocation{5}
}
