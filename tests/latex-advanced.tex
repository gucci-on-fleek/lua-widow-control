...
\usepackage{linebreaker} % Issue #18
...
\begin{document}
    ...
    \lwcsetup{enable=false}
    \footnotetest

    \lwcsetup{enable=true}
    \footnotetest
    ...
    \lwcsetup{enable=true}\lwcsetup{enable=true}\lwcsetup{enable=true}\lwcsetup{enable=true}\lwcsetup{enable=true}\lwcsetup{enable=true}
