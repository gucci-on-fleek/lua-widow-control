...
\subsection{\LaTeX{}}
All options can be set either as package options or with the \inlineTEX{\lwcsetup} command.
\startTABLE
\NC Enable (default) \NC \inlineTEX{\lwcsetup{enable=true}}  \NC\NR
\NC Disable \NC \inlineTEX{\lwcsetup{enable=false}}  \NC\NR
\NC \estretch/ \NC \inlineTEX{\lwcsetup{emergencystretch=3em}}  \NC\NR
\NC Selectively Disable \NC \inlineTEX{\lwcsetup{disablecmds={\aaa, \bbb}}}  \NC\NR
\NC Prevent loading \sans{microtype} \NC \inlineTEX{\lwcsetup{microtype=false}}  \NC\NR
\NC Widow Penalty \NC \inlineTEX{\lwcsetup{widowpenalty=999}}  \NC\NR
\NC Orphan Penalty \NC \inlineTEX{\lwcsetup{orphanpenalty=999}}  \NC\NR
\NC Debug Mode \NC \inlineTEX{\lwcsetup{debug=true}}  \NC\NR
\stopTABLE
...
\NC Selectively Disable \NC \inlineTEX{\prependtoks\lwc_patch_pre \to\everybefore}\meta{hook} \NC\NR
\NC          \NC \inlineTEX{\prependtoks\lwc_patch_post\to\everyafter}\meta{hook} \NC\NR
\NC Widow Penalty \NC \inlineTEX{\setuplwc{widowpenalty=999}}  \NC\NR
\NC Orphan Penalty \NC \inlineTEX{\setuplwc{orphanpenalty=999}}  \NC\NR
\NC Debug Mode \NC \inlineTEX{\setuplwc{debug=start}}  \NC\NR
\stopTABLE
