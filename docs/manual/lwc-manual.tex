...
\Lwc/ provides a few public functions and tables that you can safely use or modify as documented. Any Lua interfaces that aren't documented below are subject to change at any time, but if you do want to use an undocumented interface, please let me know and can easily document it.
...
\start
    ...
    \def\startsubsection[#1]{
        \start
            ...
            \def\from[##1]{}
            \normalexpanded{\savedsubsection[#1]}
        \stop
    }
    \let\subsection=\startsubsection
