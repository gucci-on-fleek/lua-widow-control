...
In draft mode, the paragraph costs are printed in the right margin, offset a certain distance from the page edge. By default, this offset is set to \unit{1 inch}; however, you can change this to any value that you want:
