...
\startitemize
    ...
    \item \TeX{} may warn about overfull \tex{vbox}es on pages where
    \lwc/ removed a \woo/. This happens due to the way that \lwc/
    corrects for the \tex{prevdepth} when replacing paragraphs. It
    does not actually produce an overfull \type{vbox}, but there
    is a warning nevertheless. You can set \tex{vfuzz=2.5pt} to
    hide the
    warning. \githubissue{8}
